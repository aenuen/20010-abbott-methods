...
// dict
export { dictGetNameByValue } from './dict/dictGetNameByValue'
export { dictGetValueByName } from './dict/dictGetValueByName'
// element
...
export { formatLicense } from './format/formatLicense'
...
export { objectReset } from './object/objectReset'
// replace
...
export { validateIdCard } from './validate/validateIdCard'
export { validateLicense } from './validate/validateLicense'
