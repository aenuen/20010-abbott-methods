"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("fs"),t=require("path");function n(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var r=n(e),i=n(t);const s=(e,t)=>{const n=String(e),r=String(t);return n.substr(-n.length)===r?n:n+r},a=require("fs");const o=e=>new Promise((t=>r.default.stat(e,((e,n)=>{t(e?{}:n)})))),l=e=>new Promise((t=>r.default.mkdir(e,(e=>{t(!e)}))));
/*! *****************************************************************************
