 ...
 * @returns {number|string}
 */
const telToFull = (InternationalNumber, areaNumber, telephoneNumber, extensionNumber) => {
    let formattedTel = '';
    if (telephoneNumber) {
